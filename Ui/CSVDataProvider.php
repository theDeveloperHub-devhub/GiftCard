...
use DeveloperHub\GiftCard\Model\ResourceModel\Reviews\CsvCollection;
...
class CSVDataProvider extends AbstractDataProvider
{
     ...
     * @param CsvCollectionFactory $tabsCollectionFactory
     * @param array $meta
     * @param array $data
     */
    public function __construct(
        ...
        CsvCollectionFactory $tabsCollectionFactory,
        array $meta = [],
        array $data = []
    ) {
